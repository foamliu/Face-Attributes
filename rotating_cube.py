...
def main():
    ...
    pygame.display.set_caption("Face attributes orientation visualization")
    resizewin(640, 480)
    init()
...
def draw(w, nx, ny, nz):
    ...
    drawText((-2.6, 1.8, 2), "Face Attributes", 18)
    drawText((-2.6, 1.6, 2), "Module to Euler angles data", 16)
